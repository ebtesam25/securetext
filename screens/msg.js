...
export default class Msg extends React.Component  {
  state = {
    ...
    method: '',
    imageCaptured: false,
    mesg:'MIIEvgIBADANBgkqhkiG9w0BAQEFAASCBKgwggSkAgEAAoIBAQDGdTCj5O0AR0Sy7eoFUKCMqNArEXz7U0TN4lpot6ZYGv4XfWc7c24qYJs5hpxex20ZRyg6A8c+W/SxELu5F5gZPgtt+876tFslTmiMmZfPU6ltUbULX9GayTyHSOf9AcFoH9WU8pWGzvV1',
  };
...
console.log(responseJson);
  ...
  render(){
    ...
    <View style={styles.container}>
      ...
      <Text style={{position:'relative',fontSize:60,marginTop:'20%', textAlign:'center', color:'#364f6b', fontFamily:'FuturaH'}}>View Message</Text>
      <DropDownPicker
...
/>
      <Text style={{position:'relative',fontSize:20,margin:'auto', paddingLeft:'5%', color:'#798497', fontFamily:'FuturaL', marginTop:'5%', backgroundColor:'#EAEAEA',padding:'2.5%', width:'80%', borderRadius:5,alignSelf:'center'}} >{this.state.mesg}</Text>
       ...
       <Text style={{position:'relative',fontSize:20,margin:'auto', textAlign:'center', color:'#FFF', fontFamily:'FuturaH', marginTop:'15%', backgroundColor:'#ED008C', padding:'5%', width:'70%', borderRadius:10, alignSelf:'center', elevation:1}} onPress={()=>this.setState({mesg:'Hey there!'})}>DECRYPT</Text>
